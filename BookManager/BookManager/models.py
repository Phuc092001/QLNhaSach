...
if __name__ == '__main__':
    with app.app_context():
        ...
        u = User(name='phuc', username='admin', password=password, phone='0216472212',
        ...
        u = User(name='user', username='user', password=password, phone='0216494574',
                 user_role=UserRole.USER,
                 avatar='https://res.cloudinary.com/dp87nci6w/image/upload/v1681562499/cld-sample-4_nto39d.jpg')
        db.session.add(u)
        db.session.commit()
        ...
        p1 = Book(name='LIFE 3.0',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560209/LIEF3.0_b8frkh_oezgfx.jpg')
        p2 = Book(name='Doraemon',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560212/DORAEMON_xksadg_xinuyz.jpg')
        p3 = Book(name='ISMS',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560212/isms_x7oy3w_i4do5a.jpg')
        p4 = Book(name='Khám phá thế giới tâm linh',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560208/kham_bqgasz_css3h6.jpg')
        p5 = Book(name='Thất Tịch Không Mưa',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560209/that_llregc_l8y73c.jpg')
        p6 = Book(name='Tâm Lý Học Tội Phạm',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560209/tamly_m8cs1w_jqmlpm.jpg')
        p7 = Book(name='Conan Tập 1',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560211/conan_xos5ct_hhiung.jpg')
        p8 = Book(name='Câu Chuyện Nghệ Thuật',
                  ...
                  image='https://res.cloudinary.com/dp87nci6w/image/upload/v1681560210/thuat_zc2z1q_cjlinz.jpg')
